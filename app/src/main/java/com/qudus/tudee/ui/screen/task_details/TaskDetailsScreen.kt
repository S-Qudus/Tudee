...
fun TaskDetailsScreen(
    ...
    TaskDetailsContent(taskDetailsUiState)
}

@Composable
fun TaskDetailsContent(taskDetailsUiState: TaskDetailsUiState) {
    LazyColumn(
        modifier = Modifier
        ...
        item {
            CategoryIcon(
                iconPainter = taskDetailsUiState.taskUiState.taskCategory.image.toPainter(),
                title = taskDetailsUiState.taskUiState.taskCategory.title,
                isClickable = false,
                modifier = Modifier
        ...
        item {
            Text(
                text = taskDetailsUiState.taskUiState.taskTitle,
        ...
        item {
            Text(
                text = taskDetailsUiState.taskUiState.taskDescription,
        ...
        item {
            TaskStatusAndPrioritySection(taskDetailsUiState)
        }
        item {
            TaskActionButtons()
        }
...
fun TaskDetailsContentPreview() {
    TudeeTheme(isDarkTheme = true) {
        TaskDetailsContent(taskDetailsUiState = TaskDetailsUiState())
    }
}